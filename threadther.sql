...
('23 Paskal Shopping Center', 'Jl. Pasirkaliki Bandung', 'Bandung', 'Jawa Barat'),
('BEC Mall', 'Jl. Purnawarman No. 7 - 11', 'Bandung', 'Jawa Barat'),
('Festival City Link', 'Jl. Peta 100', 'Bandung', 'Jawa Barat'),
...
(101, 900000, 2147483647, '1997-01-01'),
(102, 100000, 2147483647, '1997-01-02'),
(103, 0, 2147483647, '1997-01-03'),
(104, 0, 1324124, NULL),
(105, 0, 12341324, NULL);
...
(5, 'Mission Impossible 6', 'Ethan Hunt and his new team try to overcome badass criminal through the world most dangerous places', 5, 140, 'poster/missionimpossible.jpg', 2),
(6, 'Spider-Man Homecoming 2', 'Spidey gets his new adventure, meeting a new nice girl. What will happen next?', 5, 134, 'poster/spiderman.jpg', 2);
...
('2018-04-17 13:00:00', 2, 1, 30000),
('2018-04-19 11:00:00', 1, 1, 30000),
('2018-04-19 12:00:00', 7, 1, 35000),
('2018-04-19 14:00:00', 3, 1, 25000);
...
(104, 'The', 'Houw Liong', 'thehouwliong@gmail.com', 'asdf', 'contoh.jpg'),
(105, 'Budi', 'A', 'fil23@gmail.com', 'asdf', 'contoh.jpg'),
(106, '1', '1', '1', '1', '1');
...
--
ALTER TABLE `movie`
  MODIFY `movie_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'PK Movie AI', AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `transaction`
  MODIFY `transaction_id` int(20) NOT NULL AUTO_INCREMENT COMMENT 'PK Transaction AI';
--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `user_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
--
